 ...
 * must refresh both clocks after every call (sleep can advance them), retain
 * its source-change guard, and trap immediately on clock/time failure.
...
/* Zero while healthy; otherwise the stage at failure plus one. */
