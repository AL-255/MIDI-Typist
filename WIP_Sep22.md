...
linked-ARM and runtime-power tests pass. The factory IAP accepted this image,
and the M1 re-enumerated on USB with the expected build identity. Wireless
operation requires the hardware power switch in its wireless position;
battery current, sleep/wake, cable recovery, reconnection and long-term scan
timing remain unverified. The factory updater erases
